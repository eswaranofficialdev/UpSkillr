  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col justify-between">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center flex-1 flex flex-col items-center justify-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 text-emerald-500 font-semibold text-sm mb-6 border border-emerald-500/20">
      ...
      <div className="border-t border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 py-12">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="p-6"><Compass className="w-8 h-8 text-teal-500 mx-auto mb-3"/><h3 className="font-bold text-lg mb-1">Top Career Tracks</h3><p className="text-sm text-slate-500">Full-Stack, Data Science, AI/ML, Cloud, Cybersecurity & more.</p></div>
          <div className="p-6"><ShieldCheck className="w-8 h-8 text-cyan-500 mx-auto mb-3"/><h3 className="font-bold text-lg mb-1">Complete Privacy</h3><p className="text-sm text-slate-500">All data stored locally in your browser via localStorage.</p></div>
        </div>
      </div>
    </div>
  );
